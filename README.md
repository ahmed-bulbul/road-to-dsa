...
```
সমাধান টি একটু বুঝার চেষ্টা করি, ধরি লিস্ট ই [ ১,২,৩্‌,৩,৪]  । একটা ফ্ল্যাগ ভেরিয়েবল k = 1. লুপের ভিতর যদি খেয়াল করি, ২ এবং ১ যদি সমান না হয় তাহলে ২ এর পজিশনে ২ই বসবে । এছাড়া একই ইলিমেন্ট থাকলে কে এর মান মারবে না । 
